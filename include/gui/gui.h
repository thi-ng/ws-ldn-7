...
void handleToggleButton(GUIElement *bt, GUITouchState *touch);
void handleRadioButton(GUIElement *bt, GUITouchState *touch);
void renderButton(GUIElement *bt);

void handleDial(GUIElement *bt, GUITouchState *touch);
void renderDial(GUIElement *bt);
