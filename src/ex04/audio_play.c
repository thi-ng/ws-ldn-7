...
static CTSS_DSPNodeHandler oscFunctions[] = { ctss_process_osc_spiral,
		ctss_process_osc_sin, ctss_process_osc_square,
		ctss_process_osc_saw, ctss_process_osc_sawsin,
		ctss_process_osc_tri, ctss_process_pluck,
		ctss_process_pluck };
...
static void initAppGUI() {
	...
	// OSC1 types
	gui->items[6] = guiToggleButton(6, NULL, 95, 90, 1.0f, &soloSheet,
			gui_cb_setOsc1Fn);
	gui->items[7] = guiToggleButton(7, NULL, 95, 120, 2.0f, &soloSheet,
			gui_cb_setOsc1Fn);
	gui->items[8] = guiToggleButton(8, NULL, 95, 150, 4.0f, &soloSheet,
			gui_cb_setOsc1Fn);
	// OSC2 types
	gui->items[9] = guiToggleButton(9, NULL, 175, 90, 1.0f, &soloSheet,
			gui_cb_setOsc2Fn);
	gui->items[10] = guiToggleButton(10, NULL, 175, 120, 2.0f, &soloSheet,
			gui_cb_setOsc2Fn);
	gui->items[11] = guiToggleButton(11, NULL, 175, 150, 4.0f, &soloSheet,
			gui_cb_setOsc2Fn);
	// Filter types
	gui->items[12] = guiToggleButton(12, NULL, 255, 90, 1.0f, &soloSheet,
			gui_cb_setFilterType);
	gui->items[13] = guiToggleButton(13, NULL, 255, 120, 2.0f, &soloSheet,
			gui_cb_setFilterType);
	// Tempo
